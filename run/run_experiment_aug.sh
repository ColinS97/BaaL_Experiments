...
#SBATCH --output=output-cifarnet_mcdropout_1_augmented_100_epochs.out
#SBATCH --error=output-cifarnet_mcdropout_1_augmented_100_epochs.out
...
python ../cifarnet_mcdropout_augmented_cifar10.py --augment 1 --epoch 100
